#!/bin/bash
#SBATCH --time=50:00:00 #modifier pour vos besoins
...
python /home/julavoie/code/test-vs/info-crue-cmip6/workflow.py CMIP6_ScenarioMIP_IPSL_IPSL-CM6A-LR_ssp370_r1i1p1f1_globa
